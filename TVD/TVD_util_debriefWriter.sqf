...
_textOut = composeText [_outcome,
	...
	parseText format ["<t color='%1'>%2</t>   &lt;-&gt;   <t color='%3'>%4</t>",_sColor select _si0, wmt_PlayerCountNow select _si0, _sColor select _si1, wmt_PlayerCountNow select _si1], 
																							parseText format ["<t align='right'> <t color='%1'>%2</t>   &lt;-&gt;   <t color='%3'>%4</t></t><br/>",_sColor select _si0, (wmt_playerCountInit select _si0) - (wmt_PlayerCountNow select _si0) - (TVD_RetrCount select 0),_sColor select _si1, (wmt_playerCountInit select _si1) - (wmt_PlayerCountNow select _si1) - (TVD_RetrCount select 1)],
